...
{
    public class Gbl_Type_Catalog : IBusinessLogic
    {
        #region Region [Methods]
        /// <summary>
        /// Nombre: DoWork
        /// Descripcion: Metodo encargado de orquestar las solicitudes de operaciones para el objeto "GBL_TYPE_CATALOG".
        ...
        public async virtual Task<Message> List(Message message)
        {
            try
            {
                ...
                var model = message.DeSerializeObject<Common.Gbl_Type_Catalog>();
                using (var repository = new Gbl_Type_Catalog_Repository(message.Connection))
                {

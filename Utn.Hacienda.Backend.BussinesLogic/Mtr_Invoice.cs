...
{
    public class Mtr_Invoice : IBusinessLogic
    {
        #region Region [Methods]
        /// <summary>
        /// Nombre: DoWork
        /// Descripcion: Metodo encargado de orquestar las solicitudes de operaciones para el objeto "MTR_INVOICE".
        ...
        public async virtual Task<Message> List(Message message)
        {
            try
            {
                ...
                var model = message.DeSerializeObject<Common.Mtr_Invoice>();
                using (var repository = new Mtr_Invoice_Repository(message.Connection))
                {

...
{
    public class Gbl_Catalog : IBusinessLogic
    {
        #region Region [Methods]
        /// <summary>
        /// Nombre: DoWork
        /// Descripcion: Metodo encargado de orquestar las solicitudes de operaciones para el objeto "GBL_CATALOG".
        ...
        public async virtual Task<Message> List(Message message)
        {
            try
            {
                ...
                var model = message.DeSerializeObject<Common.Gbl_Catalog>();

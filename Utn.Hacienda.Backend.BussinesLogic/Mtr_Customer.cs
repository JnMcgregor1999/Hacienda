...
{
    public class Mtr_Customer : IBusinessLogic
    {
        #region Region [Methods]
        /// <summary>
        /// Nombre: DoWork
        /// Descripcion: Metodo encargado de orquestar las solicitudes de operaciones para el objeto "MTR_CUSTOMER".
        ...
        public async virtual Task<Message> List(Message message)
        {
            try
            {
                ...
                var model = message.DeSerializeObject<Common.Mtr_Customer>();
                using (var repository = new Mtr_Customer_Repository(message.Connection))
                {
